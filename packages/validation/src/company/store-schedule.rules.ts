 ...
 *
 * Regras puras, sem tela e sem armazenamento. Moram neste pacote, e não no
 * painel, porque o servidor recusa pedido de loja fechada com as mesmas contas
 * que a página mostra ao cliente — e as duas pontas não podem discordar.
 *
