  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        ...
        description: 'Cobrado, repasse, contribuição e margem por cliente e modalidade.',
      ...
      },
      {
        ...
        description: 'Competência, fatura, recebimento e repasse ligados por pedido.',
        href: '/relatorios/extrato-financeiro',
        icon: ReceiptText,
        tone: 'bg-blue-500/10 text-blue-700 ring-blue-500/15',
      },
      {
        title: 'Previsão de caixa',
        description: 'Vencimentos, repasses, saques abertos e movimentos realizados por data.',
      ...
      },
      {
        ...
        description: 'Autores, motivos e mudanças em ajustes, faturas e saques.',
        href: '/relatorios/auditoria-financeira',
        icon: FileClock,
        tone: 'bg-slate-500/10 text-slate-700 ring-slate-500/15',
      },
    ],
  },
];
