...
4. Treat the current automated suites as useful but incomplete: Company Web has initial coverage for auth/session/realtime cache, Admin Web has only narrow unit coverage, and mobile coverage is limited. State coverage gaps precisely.
